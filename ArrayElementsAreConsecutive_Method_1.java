...
public class ArrayElementsAreConsecutive_Method_1 {

	public static void main(String[] args) {
		ArrayElementsAreConsecutive_Method_1 consecutive = new ArrayElementsAreConsecutive_Method_1();
		int arr[] = { 5, 4, 2, 3, 1, 6 };
		int n = arr.length;
	...
	boolean areConsecutive(int arr[], int n) {
		...
		if (max - min + 1 == n) {
			/* Create a temp array to hold visited flag of all elements. Note
			 * that, calloc is used here so that all values are initialized as
			 * false */
